    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const response = await newRequest.put(`/api/cars/${id}`, dataToSend, {
                    headers: {
                        Authorization: user.token,
                    },
                });
                toast.success("Car details updated successfully!");
                console.log("Car Detail Update successfully:", response.data);
            } catch (error) {
                console.error("Error During Updation car:", error);
                ...
                <div className="flex justify-center">
                    <div className="w-4/5 flex items-center justify-center bg-gray-100">
                        ...
                        <div className="bg-white p-5 rounded-lg shadow-lg w-full">
                            <h1 className="text-3xl font-semibold text-center mb-6 text-blue-700">Update the Car</h1>
